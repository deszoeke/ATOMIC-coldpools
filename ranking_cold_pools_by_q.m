% Temporal structure of individual cold pools ranked by their change in q
...
delta_q = qair(t_max_ind(num_vector)) - qair(t_min_ind(num_vector));
cp_vector = [delta_q', num_vector', (1:length(num_vector))'];
